...
public final class ToastCustomBinding implements ViewBinding {
  ...
  private ToastCustomBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout toastLayoutRoot,
  ...
  public static ToastCustomBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ToastCustomBinding((LinearLayout) rootView, toastLayoutRoot, toastText);
    }
